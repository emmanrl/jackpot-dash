      ...
      <CardContent className="pt-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="p-4 bg-muted/40 rounded-lg border border-border">
            ...
            <p className="text-2xl font-bold text-foreground">₦{referralData.totalCommission.toFixed(2)}</p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <div>
            <div className="flex gap-2">
              <div className="bg-muted border border-border text-foreground px-4 py-3 rounded-xl flex-1 font-mono text-lg font-bold tracking-widest text-center shadow-inner select-all">
