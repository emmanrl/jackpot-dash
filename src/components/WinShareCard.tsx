...
import { Share2, Trophy, Download } from "lucide-react";
...
export default function WinShareCard({ jackpotName, prizeAmount, winDate, ticketNumber }: WinShareCardProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Button onClick={() => handleShare('twitter')} className="bg-[#1DA1F2]">
          <Share2 className="w-4 h-4 mr-2" />
          Twitter
        </Button>
        <Button onClick={() => handleShare('facebook')} className="bg-[#4267B2]">
          <Share2 className="w-4 h-4 mr-2" />
          Facebook
        </Button>
        <Button onClick={() => handleShare('whatsapp')} className="bg-[#25D366]">
          <Share2 className="w-4 h-4 mr-2" />
          WhatsApp
        </Button>
      </div>
